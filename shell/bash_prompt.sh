...
DEFAULT_PROMPT_OPTIONS=SnupPgPtn$
...
if [[ -z $PROMPT_COMMAND ]] ; then
    PROMPT_COMMAND="_aws-clock-print; _prompt_command"
else
    PROMPT_COMMAND="_aws-clock-print; $PROMPT_COMMAND; _prompt_command"
fi
